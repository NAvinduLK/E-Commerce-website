...
<body>
    ...
    <div class="container">
        <div class="lorem">
            <h3>Rio Mobiles - Sri Lankas largest mobile phone store</h3>
        </div>
        <br><br>
        <div class="lorem1">
            <P>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis quod beatae, perspiciatis iure ipsum doloribus hic, labore commodi mollitia at aspernatur voluptate excepturi corporis libero enim similique! A, at earum id minus accusantium, aut illo perferendis est expedita harum consequuntur ea quos aperiam molestias nesciunt, facilis fugit tenetur repellendus. Laboriosam aperiam eligendi eos sed, placeat qui, maiores sit saepe sapiente nemo quo, quasi quis. Iusto sit cumque sapiente aliquid amet, fugiat quaerat consequuntur cum, consequatur dolorem natus obcaecati eos distinctio error voluptas ex, quasi asperiores quia voluptatum nihil aut similique? Provident modi porro ex quas, at mollitia recusandae sequi natus.</p>
        </div>
        ...
        <div class="pre-item">
            <div class="subtitle">
                <h3>Leatest Phones</h3>
            </div>
            <div class="hr">
                <hr>
            </div>
            <?php
            $query = "select * from item order by ID desc limit 4";
